...
$of_options[] = array( 	"name" 		=> "Home Page Footer Widget Area",
						"desc" 		=> "Select your Widgets, Google Map or Empty for Home page.",
						"id" 		=> "footer_area",
						"std" 		=> "Empty",
						"type" 		=> "select",
						"options" 	=> $alt_footer_area
				);
				
$of_options[] = array( 	"name" 		=> "Google Map Embed Code",
						"desc" 		=> "Paste your Google Map Embed Code. This will be added into the footer template of your theme.",
						"id" 		=> "google_map_code",
						"std" 		=> "",
						"type" 		=> "textarea"
				);
...
// Ad Widget Block
$of_options[] = array( 	"name" 		=> "Ad Widget Block",
						"type" 		=> "heading"
				);				
$of_options[] = array( 	"name" 		=> "Ad Slider Options",
						"desc" 		=> "Ad slider",
						"id" 		=> "ad_slider",
						"std" 		=> "",
						"type" 		=> "slider"
