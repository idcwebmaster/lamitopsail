	...
	<div id="comment-<?php comment_ID(); ?>" class="comment_container">
		...
		<div class="comment-text">
			...
			<?php if ($GLOBALS['comment']->comment_approved == '0') : ?>
				<p class="awaiting-moderation"><?php _e( 'Your comment is awaiting approval', 'woocommerce' ); ?></p>
			<?php else : ?>
			
				<header>
					<p class="review_author"><?php comment_author(); ?></p> 
					...
					<p class="review_date"><?php comment_date(); ?> - <?php comment_time(); ?></p>
				</header>
