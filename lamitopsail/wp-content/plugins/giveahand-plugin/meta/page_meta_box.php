...
// Field Array
$prefix = 'category-';
$pager_meta_fields = array(
	array(
		'label'	=> 'Category include',
		'desc'	=> 'Set a category include for Portfolio page.',
		'id'	=> $prefix.'include',
		'type'	=> 'text'
	)
);
...
function save_page_meta($post_id) {
    global $pager_meta_fields;
	
	// verify nonce
	if (isset ($_POST['pager_meta_box_nonce']) and !wp_verify_nonce($_POST['pager_meta_box_nonce'], basename(__FILE__))) 
		return $post_id;
	// check autosave
