...
jQuery(document).ready(function($){
	...
	/*Custom media uploader 'by data-id' */
	$(document).on('click', '.custom_upload_button', function(event) {
		var $clicked = $(this), frame,
			input_id = $clicked.prev().attr('data-id'),
			media_type = $clicked.attr('rel');
		...
		frame.on( 'select', function() {
			...
			$('input[data-id='+input_id+']').val(attachment.attributes.url);
