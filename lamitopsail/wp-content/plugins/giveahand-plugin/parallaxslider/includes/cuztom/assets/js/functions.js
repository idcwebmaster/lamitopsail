...
jQuery( function( $ ) {
	...
	(add_events = function( object ) 
	{
		...
		$( ".cuztom-sortable-header", object ).live('click',function(){
		
		if ($( this, object ).parent().hasClass("toddled")) {
			$( this, object ).parent().removeClass("toddled").find("fieldset").slideUp();
			$( this, object ).parent().find('fieldset').slideUp();
		} else {
			$( ".cuztom-sortable-item.js-cuztom-sortable-item", object ).removeClass("toddled").find("fieldset").slideUp();
			$( this, object ).parent().addClass("toddled").find("fieldset").slideDown();
		}
			
		});
		
		$("select[id^='_layer_type_']").change(function(){
			var control = $(this); console.log(control);
				if (control.val() == 'type_image') {
					$(this).parent().parent().parent().find("input[id^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().find("input[id^='_element_caption_'].js-cuztom-colorpicker").parent().parent().parent().hide();
					$(this).parent().parent().parent().parent().find("textarea[id^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().find("select[id^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().find("label[for^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().find("input[id^='_element_video_']").parent().hide();
					$(this).parent().parent().parent().parent().find("label[for^='_element_video_']").parent().hide();
					$(this).parent().parent().parent().parent().find("input[id^='_element_image_']").parent().show();
					$(this).parent().parent().parent().parent().find("label[for^='_element_image_']").parent().show();
					$(this).parent().parent().parent().parent().find("input[id^='_element_button_']").parent().hide();
					$(this).parent().parent().parent().parent().find("label[for^='_element_button_']").parent().hide();
					$(this).parent().parent().parent().parent().find("select[id^='_element_button_']").parent().hide();
					$(this).parent().parent().parent().parent().find("input[id^='_element_button_'].js-cuztom-colorpicker").parent().parent().parent().hide();
				} else if (control.val() == 'type_video') {
					$(this).parent().parent().parent().parent().find("input[id^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().find("input[id^='_element_caption_'].js-cuztom-colorpicker").parent().parent().parent().hide();
					$(this).parent().parent().parent().parent().find("textarea[id^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().find("select[id^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().find("label[for^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().find("input[id^='_element_video_']").parent().show();
					$(this).parent().parent().parent().parent().find("label[for^='_element_video_']").parent().show();
					$(this).parent().parent().parent().parent().find("input[id^='_element_image_']").parent().hide();
					$(this).parent().parent().parent().parent().find("label[for^='_element_image_']").parent().hide();
					$(this).parent().parent().parent().parent().find("input[id^='_element_button_']").parent().hide();
					$(this).parent().parent().parent().parent().find("label[for^='_element_button_']").parent().hide();
					$(this).parent().parent().parent().parent().find("select[id^='_element_button_']").parent().hide();
					$(this).parent().parent().parent().parent().find("input[id^='_element_button_'].js-cuztom-colorpicker").parent().parent().parent().hide();
				} else if (control.val() == 'type_capt') {
					$(this).parent().parent().parent().parent().find("input[id^='_element_caption_']").parent().show();
					$(this).parent().parent().parent().parent().find("input[id^='_element_caption_'].js-cuztom-colorpicker").parent().parent().parent().show();
					$(this).parent().parent().parent().parent().find("textarea[id^='_element_caption_']").parent().show();
					$(this).parent().parent().parent().parent().find("select[id^='_element_caption_']").parent().show();
					$(this).parent().parent().parent().parent().find("label[for^='_element_caption_']").parent().show();
					$(this).parent().parent().parent().parent().find("input[id^='_element_video_']").parent().hide();
					$(this).parent().parent().parent().parent().find("label[for^='_element_video_']").parent().hide();
					$(this).parent().parent().parent().parent().find("input[id^='_element_image_']").parent().hide();
					$(this).parent().parent().parent().parent().find("label[for^='_element_image_']").parent().hide();
					...
					$(this).parent().parent().parent().parent().find("input[id^='_element_image_']").parent().hide();
					$(this).parent().parent().parent().parent().find("label[for^='_element_image_']").parent().hide();
					$(this).parent().parent().parent().parent().find("input[id^='_element_button_']").parent().show();	
					$(this).parent().parent().parent().parent().find("label[for^='_element_button_']").parent().show();
					$(this).parent().parent().parent().parent().find("select[id^='_element_button_']").parent().show();
					$(this).parent().parent().parent().parent().find("input[id^='_element_button_'].js-cuztom-colorpicker").parent().parent().parent().show();
				}	
		});
		
		
		$("select[id^='_layer_type_']>option:selected").each(function(){
			var selected = $(this); 
			$(this).parent().parent().parent().parent().parent().find("select[id^='_element_button_']").parent().hide();
			$(this).parent().parent().parent().parent().parent().find("select[id^='_element_caption_']").parent().hide();
				if (selected.val() == 'type_image') {
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_caption_']").parent().hide();
				//	$(this).parent().parent().parent().parent().find("input[id^='_element_caption_'].js-cuztom-colorpicker").parent().parent().parent().hide();
					$(this).parent().parent().parent().parent().parent().find("textarea[id^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("select[id^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_video_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_video_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_image_']").parent().show();
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_image_']").parent().show();
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_button_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("select[id^='_element_button_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_button_']").parent().hide();
				//	$(this).parent().parent().parent().parent().find("input[id^='_element_button_'].js-cuztom-colorpicker").parent().parent().parent().hide();
				} else if (selected.val() == 'type_video') {
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_caption_']").parent().hide();
				//	$(this).parent().parent().parent().parent().find("input[id^='_element_caption_'].js-cuztom-colorpicker").parent().parent().parent().hide();
					$(this).parent().parent().parent().parent().parent().find("textarea[id^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("select[id^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_video_']").parent().show();
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_video_']").parent().show();
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_image_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_image_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_button_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("select[id^='_element_button_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_button_']").parent().hide();
				//	$(this).parent().parent().parent().parent().find("input[id^='_element_button_'].js-cuztom-colorpicker").parent().parent().parent().hide();
				} else if (selected.val() == 'type_capt') {
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_caption_']").parent().show();
				//	$(this).parent().parent().parent().parent().find("input[id^='_element_caption_'].js-cuztom-colorpicker").parent().parent().parent().show();
					$(this).parent().parent().parent().parent().parent().find("textarea[id^='_element_caption_']").parent().show();
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_caption_']").parent().show();
					$(this).parent().parent().parent().parent().parent().find("select[id^='_element_caption_']").parent().show();
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_video_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_video_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_image_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_image_']").parent().hide();
					...
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_button_']").parent().hide();
				//	$(this).parent().parent().parent().parent().find("input[id^='_element_button_'].js-cuztom-colorpicker").parent().parent().parent().hide();
				} else if (selected.val() == 'type_button'){
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_caption_']").parent().hide();
				//	$(this).parent().parent().parent().parent().parent().find("input[id^='_element_caption_'].js-cuztom-colorpicker").parent().parent().parent().hide();
					$(this).parent().parent().parent().parent().parent().find("textarea[id^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("select[id^='_element_caption_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_video_']").parent().hide();
					...
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_image_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_image_']").parent().hide();
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_button_']").parent().show();	
					$(this).parent().parent().parent().parent().parent().find("select[id^='_element_button_']").parent().show();
					$(this).parent().parent().parent().parent().parent().find("label[for^='_element_button_']").parent().show();
				//	$(this).parent().parent().parent().parent().parent().find("input[id^='_element_button_'].js-cuztom-colorpicker").parent().parent().parent().show();
				} else {
					$(this).parent().parent().parent().parent().parent().find("input[id^='_element_caption_']").parent().hide();
				//	$(this).parent().parent().parent().parent().parent().find("input[id^='_element_caption_'].js-cuztom-colorpicker").parent().parent().parent().hide();
					$(this).parent().parent().parent().parent().parent().find("textarea[id^='_element_caption_']").parent().hide();
	...
	$('.cuztom').on( 'click', '.js-cuztom-add-sortable', function() 
	{
		...
		if( is_bundle )
		{
			che = parseInt(new_item.find('.cuztom-sortable-header>span>strong').html());
			new_item.find('.cuztom-sortable-header>span>strong').html(che+1);
			new_item.find('tr').each(function() {
			
					$(this).find("input[id^='_element_caption_']").parent().hide();
					$(this).find("input[id^='_element_caption_'].js-cuztom-colorpicker").parent().parent().parent().hide();
					$(this).find("textarea[id^='_element_caption_']").parent().hide();
					$(this).find("label[for^='_element_caption_']").parent().hide();
					$(this).find("select[id^='_element_caption_']").parent().hide();
					$(this).find("input[id^='_element_video_']").parent().hide();
					$(this).find("label[for^='_element_video_']").parent().hide();
					$(this).find("input[id^='_element_image_']").parent().hide();
					$(this).find("label[for^='_element_image_']").parent().hide();
					$(this).find("input[id^='_element_button_']").parent().hide();	
					$(this).find("label[for^='_element_button_']").parent().hide();
					$(this).find("select[id^='_element_button_']").parent().hide();
					$(this).find("input[id^='_element_button_'].js-cuztom-colorpicker").parent().parent().parent().hide();
