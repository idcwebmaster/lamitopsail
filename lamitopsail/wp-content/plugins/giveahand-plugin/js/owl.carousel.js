...
(function( $, window, document, undefined ) {
	...
	var Carousel = {
		...
		calculateWidth : function(){
			var base = this;
				$marg= parseInt(base.$owlItems.find('div').css('marginRight'));
				$addon = Math.floor($marg/base.options.items);
			base.itemWidth = Math.round(base.$elem.width()/base.options.items) + $addon;
		},
